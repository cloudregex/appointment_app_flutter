...
class AddDischargeCardScreen extends StatefulWidget {
  ...
  const AddDischargeCardScreen({super.key, required this.patient});

  @override
  _AddDischargeCardScreenState createState() => _AddDischargeCardScreenState();
}

class _AddDischargeCardScreenState extends State<AddDischargeCardScreen> {
  ...
  Future<void> _submitForm() async {
    // Removed validation - submit directly
    try {
      final data = {
      ...
      if (response != null && response['message'] != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to create discharge card')),
        );
      }
    } catch (e) {
      ScaffoldMessenger.of(
